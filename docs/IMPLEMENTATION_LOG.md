...
- 查重只读取当前成员。老人版无法安全处置时保留草稿、journal 和 staging 原件，引导切到标准版复核。纯手工录入只有在无图片、无 OCR 和无机器证据时才可旁路。
...
- `Scripts/screenshots.sh`：23 个生产导航路由 × Light/Dark = 46 张；标准版 38、老人版 8，全部 1179×2556 且 SHA-256 唯一，清单绑定源码提交 `5b535e4`。
