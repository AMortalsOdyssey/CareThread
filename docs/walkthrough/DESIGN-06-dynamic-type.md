...
- 长辈版：`ElderModeTests.dynamicTypeCapsAtAX2` 验证系统更大字号被明确封顶到 AX2；`ElderModeUITests.testB21AccessibilitySizeKeepsPrimaryActionsHittable` 验证医生卡和六个资料类型按钮仍可点击且按钮高度至少 60pt。
