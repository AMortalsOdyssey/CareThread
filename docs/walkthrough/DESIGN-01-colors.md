...
- 设备：iPhone 16 / iOS 18.6 模拟器；源码提交 `9a7187188e5f892e5738ad461b86736b2ef8b8c7`。
- 方法：逐屏查看 `docs/screenshots/` 的 36 张 Light/Dark PNG，并反查 `CTColor.swift` 与 Assets 的双外观定义。
